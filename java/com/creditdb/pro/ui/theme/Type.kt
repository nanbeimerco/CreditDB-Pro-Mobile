...
/**
 * 英数字フォント: Gotham (Gotham-Book, Gotham-Bold, Gotham-Light)
 * 記号・英数字は Gotham、日本語は高品質なシステムフォント（Noto Sans JP / sans-serif）へ自動フォールバック
 */
val AppFontFamily: FontFamily = FontFamily(
    ...
    Font(R.font.gotham_book, FontWeight.Medium),
    Font(R.font.gotham_bold, FontWeight.SemiBold),
